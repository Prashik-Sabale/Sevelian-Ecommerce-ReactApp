                ...
                <div className="footer">
                    <footer className="bg-white rounded-lg shadow  m-4">
                        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                            ...
                            <span className="block text-sm  sm:text-center text-black">© 2024 <Link to="/Home" target='blank' className="hover:underline">Sevelian™</Link>. All Rights Reserved.</span>
                        </div>
                    </footer>
                </div>
            </div>
